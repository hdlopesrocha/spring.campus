...
public class ShaderProgram {
	...
	public void update(Camera camera) {
		...
		matrix44Buffer.flip();
		glUniformMatrix4fvARB(projectionMatrixLocation, false, matrix44Buffer);

		camera.getViewMatrix().store(matrix44Buffer);
		matrix44Buffer.flip();
		glUniformMatrix4fvARB(viewMatrixLocation, false, matrix44Buffer);
	...
	public void setModelMatrix(Matrix matrix) {
		...
		matrix44Buffer.flip();
		glUniformMatrix4fvARB(modelMatrixLocation, false, matrix44Buffer);
	}
